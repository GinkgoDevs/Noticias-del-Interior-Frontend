...
export default async function EspectaculoPage() {
  const categorySlug = "espectaculo"
        ...
        <div className="container mx-auto px-6 lg:px-8 py-12">
          <div className="mb-8">
            ...
            <h1 className="font-serif text-5xl md:text-6xl font-bold text-foreground mb-4">
              Noticias de {category.name.toLowerCase()}
            </h1>
            <p className="text-lg text-muted-foreground max-w-2xl">
              {category.description || `Cultura, eventos y ${category.name.toLowerCase()} del interior`}
            </p>
          </div>
