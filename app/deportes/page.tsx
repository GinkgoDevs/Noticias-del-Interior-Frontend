        ...
        <div className="container mx-auto px-6 lg:px-8 py-12">
          <div className="mb-8">
            ...
            <h1 className="font-serif text-5xl md:text-6xl font-bold text-foreground mb-4">
              Últimas noticias de {category.name.toLowerCase()}
            </h1>
            <p className="text-lg text-muted-foreground max-w-2xl">
              {category.description || `Toda la información sobre ${category.name.toLowerCase()} del interior del país`}
            </p>
          </div>

          {/* Filtering currently handled server-side via query params if needed, 
              but for now we just show the latest news for this category */}
          {/* <NewsFilters showSubcategories={false} /> */}
